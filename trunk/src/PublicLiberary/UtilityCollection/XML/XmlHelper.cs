using System.Xml;
using System.Data;
using UtilityCollection.IO;
using UtilityCollection.Sys;
using System.Text;
...
namespace UtilityCollection.Xml
{
    ...
    public class XmlHelper
    {
        ...
        //构建空内容xml
        public static string GetNewXMLDoc()
        {
            StringBuilder objBuilder = new StringBuilder();
            XmlWriter objWriter = new XmlTextWriter(new System.IO.StringWriter(objBuilder));
